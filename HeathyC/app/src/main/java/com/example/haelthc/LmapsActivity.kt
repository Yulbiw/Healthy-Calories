...
import kotlinx.android.synthetic.main.activity_lmaps.*

class LmapsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_lmaps)

        etplace = findViewById(R.id.lolo_l)
        btSubmit = findViewById(R.id.bt_location_search_l)
        tvaddress = findViewById(R.id.tv_address_l)
        ...
        recode_map_button_l.setOnClickListener {
    ...
    private inner class GeoHandler : Handler(), OnMapReadyCallback {
        override fun handleMessage(msg: Message) {
            ...
            mapFragment = supportFragmentManager.findFragmentById(R.id.map_l) as SupportMapFragment?
            mapFragment?.getMapAsync(this)
        }

        override fun onMapReady(googleMap: GoogleMap?) {
            mMap = googleMap
            val mGPS: String = (findViewById(R.id.tv_address_l) as TextView).text.toString()
            ...
            if (list != null) {
                ...
                google_location_l.append("  $address")
//                tv_address.visibility = View.GONE
            } else {
                google_location_l.append("Null")
                tv_address_l.visibility = View.GONE
            }
            val recLDate: Bundle? = intent.extras
            val dateka = recLDate!!.getString("dateL")
            var userEmail = "";
                    ...
                    override fun onDataChange(p0: DataSnapshot) {
                        for (snapshot in p0.children) {
                            ...
                            if (dateka == date && mail == userEmail) {
                                ...
                                map["location"] = google_location_l.text.toString()
                                FirebaseDatabase.getInstance().reference.child("Lunch")
                                    .child(pushKey)
                                    .updateChildren(map)
                            }
