...
class FoodActivity: AppCompatActivity() , NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val breakf = findViewById<ImageView>(R.id.foodbf)
        val lunch = findViewById<ImageView>(R.id.foodlu)
        val dinner = findViewById<ImageView>(R.id.fooddi)
        val snack = findViewById<ImageView>(R.id.foodsn)

        breakf.setOnClickListener {
            val intent = Intent(this,BreakfastActivity::class.java)
            startActivity(intent)
        }
        lunch.setOnClickListener {
            val intent2 = Intent(this,LunchActivity::class.java)
            startActivity(intent2)
        }
        dinner.setOnClickListener {
            val intent3 = Intent(this,DinnerActivity::class.java)
            startActivity(intent3)
        }
        snack.setOnClickListener {
            val intent4 = Intent(this,SnackActivity::class.java)
