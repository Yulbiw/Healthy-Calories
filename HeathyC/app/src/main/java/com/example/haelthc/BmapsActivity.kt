...
import kotlinx.android.synthetic.main.activity_bmaps.*

class BmapsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bmaps)

        etplace = findViewById(R.id.lolo_b)
        btSubmit = findViewById(R.id.bt_location_search_b)
        tvaddress = findViewById(R.id.tv_address_b)
        ...
        recode_map_button_b.setOnClickListener {
    ...
    private inner class GeoHandler : Handler(), OnMapReadyCallback {
        override fun handleMessage(msg: Message) {
            ...
            mapFragment = supportFragmentManager.findFragmentById(R.id.map_b) as SupportMapFragment?
            mapFragment?.getMapAsync(this)
        }

        override fun onMapReady(googleMap: GoogleMap?) {
            mMap = googleMap
            val mGPS: String = (findViewById(R.id.tv_address_b) as TextView).text.toString()
            ...
            if (list != null) {
                ...
                google_location_b.append("  $address")
//                tv_address.visibility = View.GONE
            } else {
                google_location_b.append("Null")
                tv_address_b.visibility = View.GONE
            }
            val recBDate: Bundle? = intent.extras
            val dateka = recBDate!!.getString("dateB")
            var userEmail = "";
                    ...
                    override fun onDataChange(p0: DataSnapshot) {
                        for (snapshot in p0.children) {
                            ...
                            if (dateka == date && mail == userEmail) {
                                ...
                                map["location"] = google_location_b.text.toString()
                                FirebaseDatabase.getInstance().reference.child("Breakfast")
                                    .child(pushKey)
                                    .updateChildren(map)
                            }
